    ...
    <section id="projects">
      <div className="border-b border-neutral-900 pb-4">
          ...
          <div className="flex justify-center w-auto m-8">
            <div className="bg-black border border-neutral-800 w-1/2 h-auto rounded-md p-6">
              ...
              <div className="flex">
                <img src={project1} alt="Foto do Projeto Ignite Feed" className="border border-neutral-800 rounded-md mt-4 mb-6"/>
              </div>
